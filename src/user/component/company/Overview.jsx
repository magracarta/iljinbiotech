...
export default function Overview() {
    return (
        <div className='text-center mt-[80px] max-lg:mt-[40px] on'>
            ...
            <p className='mt-[35px] max-w-[1000px] mx-auto mb-[60px] max-lg:text-left ani3'>일진바이오텍은 인류의 건강과 보다 나은 삶을 위해 세상을 변화시키고 인류를 행복하게 만드는 바이오 회사입니다. 건강기능식품을 연구. 개발. 제조. 전문회사로서 연구개발에서부터 공정 개발. 품질 관리. 임상. 생산에 이르기까지 삼십여년 축적된 차별화된 R&D 기술과 지속적인 연구개발의 노하우. <br/><br/>
